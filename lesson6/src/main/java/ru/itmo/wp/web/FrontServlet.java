...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        try {
            invokeMethod("before", page, request, view);
            invokeMethod(route.getAction(), page, request, view);
            invokeMethod("after", page, request, view);
    ...
    private void invokeMethod(String methodName,
                              Object page,
                              HttpServletRequest request,
                              Map<String, Object> view) throws NotFoundException, ServletException, RedirectException {
        Class<?> pageClass = page.getClass();
        Method method = findMethod(pageClass, methodName);
        if (method == null) {
            throw new NotFoundException();
        }
        try {
